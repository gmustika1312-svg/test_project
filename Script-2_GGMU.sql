...
BEGIN
	...
	-- Automation: Create Table
	CREATE TABLE IF NOT EXISTS dm.dm_transaction_user_per_hourly (
	...
	-- Automation: Truncate --> SCD Type 1
    TRUNCATE TABLE dm.dm_transaction_user_per_hourly;
	-- Automation: Inserting New Data
    INSERT INTO dm.dm_transaction_user_per_hourly
    SELECT
	...
	-- Automation: Create Table
	CREATE TABLE IF NOT EXISTS dm.dm_quantity_product (
    product_id INT,
	...
	-- Automation: Truncate --> SCD Type 1
    TRUNCATE TABLE dm.dm_quantity_product;
	-- Automation: Inserting New Data
    INSERT INTO dm.dm_quantity_product
    SELECT
    product_id,
    product_name,
	...
	-- Automation: Create Table
	CREATE TABLE IF NOT EXISTS dm.dm_quantity_store (
    store_id INT,
	...
	-- Automation: Truncate --> SCD Type 1
    TRUNCATE TABLE dm.dm_quantity_store;
	-- Automation: Inserting New Data
    INSERT INTO dm.dm_quantity_store
    SELECT
    store_id,
    store_name,
    SUM(quantity) as total_quantity,
	...
	-- Peak Shopping Hour
	-- Automation: Create Table
	CREATE TABLE IF NOT EXISTS dm.dm_peak_shopping_hour (
	transaction_hour INT,
	total_transaction INT,
	total_revenue FLOAT,
	last_update TIMESTAMP
	...
	-- Automation: Truncate --> SCD Type 1
    TRUNCATE TABLE dm.dm_peak_shopping_hour;
	-- Automation: Inserting New Data
    INSERT INTO dm.dm_peak_shopping_hour
    SELECT
	EXTRACT(HOUR FROM transaction_time) AS transaction_hour,
	COUNT(*) AS total_transaction,
	...
	-- Failed Transaction Hour
	-- Automation: Create Table
	CREATE TABLE IF NOT EXISTS dm.dm_failed_transaction_hour (
	transaction_hour INT,
	failed_transaction INT,
	last_update TIMESTAMP
	);
	-- Automation: Truncate --> SCD Type 1
    TRUNCATE TABLE dm.dm_failed_transaction_hour;
	-- Automation: Inserting New Data
    INSERT INTO dm.dm_failed_transaction_hour
    SELECT
	EXTRACT(HOUR FROM transaction_time) AS transaction_hour,
	COUNT(*) AS failed_transaction,
	CURRENT_TIMESTAMP AS last_update
    FROM dm.dm_cube_ecommerce_transaction
...
-- ============================================================
-- STEP 15: EXECUTE ETL PROCESS
-- ============================================================
CALL dwh.generate_ecommerce_transaction();

-- ============================================================
-- VERIFICATION - CHECK DATAMART RESULTS
-- ============================================================
